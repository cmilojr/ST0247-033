class Bfa3_0():
  ...
  def permutacionesRepeticion(self, elementos, s, cantidad):

      """
      Funcion que genera las combinaciones posibles
      con repeticion letras que pueden salir de un conjunto
      """
      if cantidad == 0:
        
        self.__listtR.append(s)
        print(s)
        ...
        for i in range(len(elementos)):
          print(i)
          self.permutacionesRepeticion(elementos, s + elementos[i], cantidad - 1)
